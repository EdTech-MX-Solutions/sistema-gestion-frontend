...
function PersonalData({ alumno }: { alumno: InterfaceAlumno }) {
  return (
    <>
      <div className="pt-5 pb-10 mt-5 -ml-6 -mr-6 pl-6 bg-green-100 bg-opacity-40 dark:bg-opacity-20 md:text-xl text-gray-900 dark:text-gray-200 text-base">
      ...
      <p className="md:text-lg text-gray-500 dark:text-gray-200 text-base">
