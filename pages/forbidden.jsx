            ...
            <main className="bg-secondary dark:bg-slate-600">
                <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                    <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                        <p className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-wider  text-orange-400 dark:text-orange-300 mt-2">
                            <span className="block text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-red-500 ">
                                Prohibido,
                            </span>
                            el Acceso a esta Página.
                        </p>
                        <p className="mx-20 text-lg md:text-xl lg:text-2xl text-gray-500 dark:text-gray-200 my-6">
                            Lo sentimos, no tienes permisos para acceder a esta página. Si crees que esto es un error, por favor contacta a la dirección del plantel.
                        </p>
                        <div className='flex gap-2'>
                            <Link href='/' className="group flex bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded">
                    ...
                    <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
                        <svg className="w-full text-red-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1120.59226 777.91584" xmlnsXlink><title>not found</title><circle cx="212.59226" cy="103" r="64" className="text-orange-500" fill="currentColor"/>
