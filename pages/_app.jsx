    ...
    return (
        <CookiesProvider>
            ...
            <main className="bg-secondary dark:bg-slate-700 -z-10">
                ...
                <div>
                    <div className="fixed -bottom-10 right-0 z-10 opacity-10">
