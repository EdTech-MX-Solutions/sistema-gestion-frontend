            ...
            <main className="bg-secondary dark:bg-slate-600">
                <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                    <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                        <p className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-wider  text-cyan-600 dark:text-cyan-400 mt-2">
                            <span className="block text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-teal-500 ">
                                Conoce,
                            </span>
                            al Aviso de Privacidad
                        </p>
                        <p className="mx-20 text-lg md:text-xl lg:text-2xl text-gray-500 dark:text-gray-200 my-6">
                            El siguiente boton te permitira descargar en PDF el aviso de privacidad de acuerdo a la ley de protección de datos personales.
                        </p>
                        <div className='flex gap-2'>
                            <a target='_blank' href='https://drive.google.com/file/d/14nxFBtVUqW16QmlpkT-wneZ7kIaMFEL5/view?usp=sharing' className="group flex bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded">
                                <svg className="w-4 h-4 mr-1 group-hover:w-5 group-hover:h-5 transition-all duration-300 ease-in-out my-auto"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" >
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                                </svg>
                                Descargar
                            </a>
                            <Link href='/' className="group flex bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded">
                                <svg className="w-4 h-4 mr-1 group-hover:w-5 group-hover:h-5 transition-all duration-300 ease-in-out my-auto"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" >
