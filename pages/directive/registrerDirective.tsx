    ...
    return(
        <>
          <div className="container mx-auto justify-center py-5">
                <h1 className="text-4xl font-bold text-center bg-white p-5 rounded-full"> Registro Directivo </h1>
           </div>
              ...
              <div className="p-7 bg-green-200 rounded-lg">
                ...
                <form>
                  <div className="grid grid-cols-3 gap-4 items-center">
                    ...
                    <div>
                      <label htmlFor="" className="block mb-2 text-sm font-medium text-gray-900"> Permisos: </label>
                        <select name="" id="" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-4/5 p-2.5">
                  ...
                  <h4 className="font-bold pb-5 pt-10"> Datos de contacto </h4>
                    ...
                    <div className="text-center pt-10">
                      <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Registrar Directivo </button>
                    </div>
                </form>
              </div>
            </div>
