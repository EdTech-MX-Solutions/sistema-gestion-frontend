...
export default function SignIn({
    ...
    async function onSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        await fetch(
            `${base_rute}/${version}/${route}?email=${email}&redirectUrl=http://localhost:3000`,
            {
                method: "GET",
            }
        );
        ...
        <>
            <div className="h-screen w-screen bg-green-100 bg-opacity-50 justify-center dark:bg-slate-800">
                <div className="flex h-full pt-5 sm:pt-10 md:pt-20 flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
                    <div className="md:m-20 sm:m-10 m-5 z-20">
                                    ...
                                    <div className="mx-auto px-4 py-6 text-white lg:mx-12 md:p-12 text-center">
                                        ...
                                        <div className="pt-10">
                                            <form onSubmit={onSubmit}>
                                                ...
                                                {enviado ? (
                                                  <>
                                                    <div className="mt-5 flex w-full justify-center px-3 py-1.5 text-sm font-semibold leading-6 text-green-700 selection:bg-green-600 selection:text-white">
                                                        Si el correo existe, se
                                                    ...
                                                    <button className="group mt-5 flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                                                        {loading ? (
                                                            <svg
                                                                aria-hidden="true"
                                                                role="status"
                                                            ...
                                                            <svg
                                                                className="ml-2 w-4 h-4 mr-2 my-auto group-hover:animate-pulse transition duration-500"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                                                stroke-width="1.5"
                                                 ...
                                                 <div>
                                                    <Link href='/' className="group flex w-1/3 text-green-600 mx-auto py-2 px-2 rounded">
                ...
                <div>
                    <div className="fixed -bottom-10 right-0 z-10 w-full lg:w-1/2 opacity-10">
                        <svg
                    ...
                    <div className="fixed -bottom-10 left-0 z-10 w-full lg:w-1/2 opacity-10">
                        <svg
                            className="w-full text-cyan-600"
                            xmlns="http://www.w3.org/2000/svg"
                            data-name="Layer 1"
