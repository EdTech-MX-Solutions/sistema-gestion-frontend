                    ...
                    <div className=" lg:m-15 sm:m-10 m-5 z-20">
                        <div className="block rounded-2xl bg-white shadow-2xl dark:bg-slate-500 bg-opacity-100">
                            <div className="g-0 lg:flex lg:flex-wrap">
                                <div className="px-4 md:px-0 w-full lg:w-6/12 max-h-[60vh] max-w-[60vh] mx-auto">
                                    <div className="md:mx-6">
                                        <div className="text-center">
                                            <img
                                                className="mx-auto dark:hidden max-w-3/4 lg:w-full h-1/2"
                                                src="/logo.png"
                                                alt="SIGE Logo"
                                            />
                                            <img
                                ...
                                <div className="w-full lg:w-6/12 flex items-center rounded-b-lg lg:rounded-r-lg lg:rounded-bl-none">
                                    <div className="mx-auto px-4 py-6 text-white lg:mx-12 md:p-12 text-center">
                                        ...
                                        <div className="pt-10">
                                            ...
                                            <button
                                                className="group flex w-full items-center justify-center rounded-md bg-green-600 px-3 py-1.5 text-xs sm:text-sm font-semibold leading-6 text-white shadow-sm hover:bg-cyan-500 transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    signIn("google");
                                                }}
                                            >
                                                <svg
                                                    className="ml-2 w-3 h-3 mr-2 group-hover:animate-pulse transition duration-500"
                                                    aria-hidden="true"
                                                    focusable="false"
                                                    data-prefix="fab"
                                                    data-icon="google"
                                        ...
                                        <Link
                                            ...
                                            className="group mt-5 flex w-full items-center justify-center rounded-md bg-green-600 px-3 py-1.5  text-xs sm:text-sm font-semibold leading-6 text-white shadow-sm hover:bg-cyan-500 transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                                        >
                                            <svg
                                                className="ml-2 w-4 h-4 mr-2 group-hover:animate-pulse transition duration-500"
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke-width="1.5"
